...
contrast_matrix <- makeContrasts(PHOX2B_vs_EV_proliferation=groupPHOX2Bproliferation-groupEVproliferation,
                                 ...
                                 differentiation_vs_proliferation=c(1,-1,1,-1,1,-1),
                                 differentiation_vs_proliferation_3=c(1,-1,0.5,-0.5,0.5,-0.5),
                                 PHOX2B_vs_EV=c(-1,-1,1,1,0,0),
                                 PTPRK_vs_EV=c(-1,-1,0,0,1,1),
                                 differentiation_vs_proliferation_EV=c(1,-1,0,0,0,0),
                                 differentiation_vs_proliferation_PHOX2B=c(0,0,1,-1,0,0),
                                 differentiation_vs_proliferation_PTPRK=c(0,0,0,0,1,-1),
                                 levels=design)
...
```{r}
annotation_col_df <-  dplyr::select(meta_data_sheet, gRNA)
...
plot_sample_heatmap(log_cpm,
                    ...
                    annotation_col = annotation_col_df["gRNA"],
